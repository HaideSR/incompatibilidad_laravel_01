	...
	<body>
      <div class="bx-pdf-print">
         <div class="pr-head">
            ...
            <p class="bold mt text-center">DECLARACIÓN JURADA DE INEXISTENCIA DE INCOMPATIBILIDADES</p>
         </div>
         <div class="pr-bloque">
         ...
         <div class="pr-bloque">
            <p class="bold">Detallar los parientes hasta 4° grado de consanguinidad y 2° grado de afinidad que trabajan en el Ministerio Público</p>
            <table>
               <thead>
                  <tr>
                     <th>Nombres</th>
         ...
         <div class="pr-bloque">
            <p class="italic">"Juro la exactitud y veracidad de los datos declarados en el presente documento a la fecha de su presentación,
               asimismo autorizo expresamente a los funcionarios del Ministerio Público a verificar la información proporcionada
               comprometiéndome a presentar la documentación que sustente lo declarado en caso de ser requerido."</p>
         </div>
