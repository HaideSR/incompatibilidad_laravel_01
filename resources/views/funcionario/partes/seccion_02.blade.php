...
<section class="form-step">
   <div class="accordion-body">
      <table class="table">
         ...
         <tbody>
            @foreach($consaguinidades as $persona)
               <tr>
                  ...
                  @endif
                     <a href="{{ route('consaguinidad.edit', $persona->id) }}" class="btn btn-sm btn-outline-info">
                        <i class="icon-create"></i> 
                     </a>
                     <form action="{{ route('consaguinidad.destroy', $persona->id) }}" method="POST" class="inline">
                        @csrf
                        {{ method_field('DELETE') }}
