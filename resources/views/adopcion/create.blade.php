...
<div class="card max-800">
   <div class="card-body">
      <h4 class="text-center title-frm">Agregar Familiar por adopción</h4>

      <form action="{{'/adopcion'}}" method="post" enctype="multipart/form-data" class="row g-3 form-register">
         @csrf
